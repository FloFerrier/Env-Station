...
SRC= $(wildcard *.c) $(wildcard BSP/*.c) $(wildcard Driver/HC05/*.c) $(wildcard Debug/printf/*.c)
HDR= $(wildcard *.h) $(wildcard BSP/*.h) $(wildcard Driver/HC05/*.h) $(wildcard Debug/printf/*.h)
OBJ= $(SRC:.c=.o)
